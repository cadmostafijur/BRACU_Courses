...
speed = .8
color = 0  # Default color (for day or night)
bg_color = 1  # Background color (default light background)
create_new = False
...
def drawShapes():
    # House roof color - change to a light brown shade
    glBegin(GL_TRIANGLE_STRIP)
    glVertex2d(-170, 100)
    glColor3f(0.8, 0.6, 0.4)  # New roof color
    glVertex2d(170, 100)
    glColor3f(0.8, 0.6, 0.4)
    glVertex2d(0, 160)
    glEnd()

    # House base color - change to a beige shade
    glBegin(GL_QUADS)
    glVertex2d(-165, 100)
    glColor3f(0.9, 0.8, 0.6)  # New house base color
    glVertex2d(165, 100)
    ...
    # Window (left) - new white color
    glBegin(GL_QUADS)
    glColor3f(1, 1, 1)  # White window color
    glVertex2d(100, 60)
    glColor3f(1, 1, 1)
    glVertex2d(140, 60)
    glColor3f(1, 1, 1)
    ...
    # Door color - changed to dark brown
    glBegin(GL_QUADS)
    glColor3f(0.4, 0.2, 0.1)  # Door color
    glVertex2d(-110, 30)
...
def drawline():
    ...
    glBegin(GL_LINES)
    glColor3f(0, 10, 0)  # konokichur color set (RGB)
    ...
    glLineWidth(5)  # pixel size. by default 
